...
@Table(
        ...
        indexes = {
                @Index(
                        name = "idx_market_candle_raw_symbol_interval_open_time",
                        columnList = "symbol, interval_value, open_time"
                ),
                @Index(
                        name = "idx_market_candle_raw_symbol_interval_close_time",
                        columnList = "symbol, interval_value, close_time"
                )
        }
)
