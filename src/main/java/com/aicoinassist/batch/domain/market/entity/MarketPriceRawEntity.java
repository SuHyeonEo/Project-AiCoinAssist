...
@Table(
        ...
        indexes = {
                @Index(name = "idx_market_price_raw_symbol_collected_time", columnList = "symbol, collected_time"),
                @Index(name = "idx_market_price_raw_symbol_source_event_time", columnList = "symbol, source_event_time")
        }
)
